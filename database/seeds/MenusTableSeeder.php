...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    public function run()
    {
        ...
        $this->insertLink('user,admin', 'Demandas', '/admin/demands', 'cui-short-text');
        $this->insertLink('user,admin', 'Precio de ventas', '/admin/sales_price', 'cui-money');
        $this->insertLink('user,admin', 'Precio de compras', '/admin/purchases_price', 'cui-money');
        $this->insertLink('user,admin', 'Tablas Simulacion', '/admin/simulation', 'cui-puzzle');
