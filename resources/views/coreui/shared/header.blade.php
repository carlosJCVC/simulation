    ...
    <div class="c-wrapper">
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <ul class="c-header-nav d-md-down-none">
          ...
          <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="{{ route('admin.demands.index') }}">Demandas</a></li>
          <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="/users">Graficos</a></li>
        </ul>
